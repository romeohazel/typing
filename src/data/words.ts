// Top ~200 most common English words. Lowercase, no punctuation.
// Used as the source pool for random word streams in time mode.
export const TOP_200: readonly string[] = [
